...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>ГидОнлайн - Добавление фильма</title>
  </head>
...
<div class="container my-5 justify-content-center" style="background-color: #111;">
            <div class="container col-sm-8 offset-sm-2">
              <br>
                <h1 class="mb-3" style="color:#dadada;">ГидОнлайн - Добавление фильма</h1>
                <div>
                    @if ($errors->any())
                    ...
                    <form method="post" action="{{ route('film.add') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-4">
                                ...
                                <input type="number" class="form-control" name="year" style="background-color: #333; color: #dadada;"/>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="text-secondary" for="responsibilities">Страна:</label>
                            <input type="text" class="form-control" name="country" style="background-color: #333; color: #dadada;"/>
                        </div>
                        <div class="form-group">
                            <label class="text-secondary" for="requirements">Длительность (мин):</label>
                            <input type="text" class="form-control" name="duration" style="background-color: #333; color: #dadada;"/>
                        </div>
                        <div class="form-group">
                            <label class="text-secondary" for="terms">Режиссер:</label>
                            <input type="text" class="form-control" name="director" style="background-color: #333; color: #dadada;"/>
                        </div>

                        <div class="form-group">
                            <label class="text-secondary" for="min_salary">Описание фильма:</label>
                            <textarea class="form-control" name="description" id="description" rows="5" style="background-color: #333; color: #dadada;"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="text-secondary" for="max_salary">Ссылка на картинку:</label>
                            <input type="text" class="form-control" name="image" style="background-color: #333; color: #dadada;"/>
                        </div>

                        <div class="form-group">
                            <label class="text-secondary" for="skills">Рейтинг (0-10):</label>
                            <input type="number" class="form-control" name="stars" style="background-color: #333; color: #dadada;"/>
                        </div>

                        <div class="form-group">
                            <label class="text-secondary" for="video" style="color: #dadada;">Ссылка на видео:</label>
                            <input type="text" class="form-control" id="video" name="video" style="background-color: #333; color: #dadada;"/>
                        </div>
                        ...
                        <br>
                        <button type="submit" class="btn btn-dark">Добавить фильм</button>
                        <br><br>
                    </form>
                </div>
            </div>
